        ...
        <div v-if="!loading" class="filter">
            ...
            <div v-if="!loading" class="row result">
                        ...
                        <div class="card-columns">
                                ...
                                <div v-for="news in news" v-bind:key="news.id" class="card mb-4 scene_element scene_element--fadeinup" style="width: 18rem;">
                                    ...
                                    <div class="card-footer text-muted">
                                        <p class="float-left text-muted">{{news.created.date | formatDate}}</p>
                                        <p v-if="lang == 'nl'" class="float-right text-muted ">{{news.category.nameNl}}</p>
                                        <p v-if="lang == 'fr'" class="float-right text-muted">{{news.category.nameFr}}</p>
                                        <p v-if="lang == 'en'" class="float-right text-muted">{{news.category.nameEn}}</p>
                                    </div>
